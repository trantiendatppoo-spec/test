local v14 = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))();
    Title = "EMMAWATSON HUB [ Premium ]"
    SubTitle = "By PhanThanh"
    TabWidth = 160,
    Theme = "Dark",--màu
    Acrylic = false,
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("emmawatson pretty");
    end
});
v16.Home:AddButton({
    Title = "Zalo Group",
    Description = "Click(Copy)",
    Callback = function()
        setclipboard("emmawatson");
    end
});
v16.Home:AddButton({
    Title = "Remember:",
    Description = "this is emmawatson pretty",
    Callback = function()
        setclipboard("harrypotter sắp ra tập mới");
    end
});
